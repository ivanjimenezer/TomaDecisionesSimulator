 ...
 * @author oscar
 */
public class Enlaces extends JFrame{
    ...
    public Enlaces(int x1, int y1, int x2, int y2,String Nombre,String Modo,int colorEnlace,String Nodo1,String Nodo2,String idEnlace) {
        this.x1 = x1;
        this.y1 = y1;
        this.x2 = x2;
        this.y2 = y2;
