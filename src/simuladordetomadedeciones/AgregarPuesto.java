...
public class AgregarPuesto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(676, 423));
    ...
    public void mostrar_ocupados(Connection conexion2, String like){
        ...
        String sql = "SELECT PUESTO.IDPUESTO, PUESTO.NOMBREPUESTO, EMPLEADOS.NOMBREEMPLEADO, EMPLEADOS.RFC " +
                     "FROM PUESTO " +
                     "LEFT JOIN EMPLEADOS ON EMPLEADOS.IDEMPLEADOS = PUESTO.EMPLEADOIDPUESTO "+
